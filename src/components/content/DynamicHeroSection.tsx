...
export function DynamicHeroSection() {
  ...
  if (loading) {
    return (
      <div className="w-full h-[70vh] md:h-[calc(100vh-88px)] bg-[#050f1f] flex items-center justify-center">
  ...
  if (articles.length === 0) {
    return (
      <div className="w-full h-[70vh] md:h-[calc(100vh-88px)] relative">
        ...
        <div className="absolute inset-0 flex items-end pb-8 md:pb-16">
          <div className="px-4 md:px-8 max-w-2xl">
            <h1 className="font-bold text-[#d0f6ff] mb-4 drop-shadow-[0_0_30px_rgba(0,196,255,0.5)] text-3xl md:text-5xl">
              The Qriptopian
            </h1>
            <p className="text-base md:text-xl text-[#8fb3c0] drop-shadow-[0_0_20px_rgba(0,0,0,0.8)]">
  ...
  return (
    <Carousel 
      ...
      className="w-full h-[70vh] md:h-[calc(100vh-88px)] relative flex-shrink-0"
    >
      <CarouselContent className="h-[70vh] md:h-[calc(100vh-88px)]">
        {articles.map((article) => {
          ...
          return (
            <CarouselItem key={article.id} className="h-[70vh] md:h-[calc(100vh-88px)] relative">
              <div 
