    ...
    <div className="w-full bg-[#071327] py-12 px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <Carousel className="w-full">
          ...
          <CarouselPrevious className="left-0 bg-[#020b18]/80 border-[#1e2b40] text-cyan-400 hover:bg-[#020b18] hover:text-cyan-300" />
          <CarouselNext className="right-0 bg-[#020b18]/80 border-[#1e2b40] text-cyan-400 hover:bg-[#020b18] hover:text-cyan-300" />
        </Carousel>
      </div>
    </div>
  );
